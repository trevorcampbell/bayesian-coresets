...
n_trials = 10
tol = 1e-6
tests = [(N, D, dist, search_method) for N in [1, 10, 100] for D in [1, 3, 10] for dist in ['gauss', 'bin', 'gauss_colinear', 'bin_colinear', 'axis_aligned'] for search_method in ['linear', 'tree', 'adaptive'] ]
