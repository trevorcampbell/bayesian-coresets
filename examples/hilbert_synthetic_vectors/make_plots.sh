...
#python3 main.py plot Ms err --plot_legend alg_nm --summarize trial
...
#python3 main.py plot csize err --plot_legend alg_nm --summarize trial
...
#python3 main.py plot cput err --plot_legend alg_nm --summarize trial
